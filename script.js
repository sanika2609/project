const quizData = [
    ...
    { question: "What ocean lies between Africa and Australia?", a: "Atlantic Ocean", b: "Indian Ocean", c: "Pacific Ocean", d: "Arctic Ocean", correct: "b" },
    { question: "Which country is known as the Land of the Rising Sun?", a: "China", b: "Japan", c: "Thailand", d: "South Korea", correct: "b" },
    { question: "What is the smallest country in the world?", a: "Monaco", b: "Vatican City", c: "San Marino", d: "Nauru", correct: "b" },
    { question: "Which gas do plants absorb from the atmosphere?", a: "Oxygen", b: "Carbon Dioxide", c: "Nitrogen", d: "Hydrogen", correct: "b" },
    { question : 'What is the hardest natural substance on Earth?', a : 'Gold', b : 'Diamond', c : 'Iron', d : 'Quartz', correct : 'b' },
    { question : 'Who wrote \"Romeo and Juliet\"?', a : 'Charles Dickens', b : 'Mark Twain', c : 'William Shakespeare', d : 'Jane Austen', correct : 'c' },
    { question :  'What is the largest mammal in the world?', a :  'Elephant', b :  'Blue Whale', c :  'Giraffe', d :  'Great White Shark', correct :'b' },
    { question : 'Which element has the chemical symbol O?', a : 'Gold', b : 'Oxygen', c : 'Silver', d : 'Iron', correct : 'b' },
    { question : 'In what year did World War II end?', a : '1945', b : '1939', c : '1950', d : '1940', correct : 'a' },
    { question : 'What is the main ingredient in guacamole?', a : 'Tomato', b : 'Avocado', c : 'Pepper', d : 'Onion', correct : 'b' },
    { question : 'Which planet has rings around it?', a : 'Earth', b : 'Mars', c : 'Saturn', d : 'Neptune', correct : 'c' },
    { question : 'What is H2O more commonly known as?', a : 'Hydrogen Peroxide', b : 'Salt Water', c : 'Water', d : 'Alcohol', correct : 'c' },
    { question :  'Which continent is known as the Dark Continent?', a :  'Asia', b :  'Africa', c :  'Australia', d :  'South America', correct :'b' },
...
signupForm.addEventListener('submit', function(event) {
    ...
    if (username) {
        alert(`Thank you for signing up, ${username}! You can now log in.`);
        showLogin();
    }
});
...
// Show signup form when the link is clicked
